...
Check product's name, quantity and price in cart. 

Given I am logged in with "standard_user" and I am on Products page
When I open the inventory item page for "BackpackItemLink" product
And I click "backpackInventoryItemAddToCart" to add product to cart
And I go to check my cart
Then I should see that the product name is "Sauce Labs Backpack"
And I should see that the quantity of the product is 1
And I should see that the price of the product is "$29.99"
